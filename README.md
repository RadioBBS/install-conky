...
Signalstaerke, LAN, Temperatur, CPU, RAM, Disk, …). Standard:
**unten rechts am Bildschirmrand angedockt**, weisse Schrift,
Transparenz 90. Zwei Netzbloecke: **WLAN** und **LAN** (jeweils Name,
IPv4, IPv6, Traffic). Die Schnittstellennamen werden automatisch
ermittelt (`end0`, `eth0`, `wlan0`, …). Nach jeder Aenderung das
Skript erneut mit `sudo` ausfuehren.
...
- Version 1.3.0 – 2026-08-23 – Traffic je NIC; LAN/WLAN-Namen automatisch.
